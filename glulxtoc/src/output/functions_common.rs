...
impl GlulxOutput {
    ...
    pub fn output_common_instruction(&self, instruction: &Instruction, args: Vec<String>) -> String {
        ...
        match opcode {
            ...
            OP_ASTORE => format!("store_operand(1, {} + 4 * {}, {})", op_a, op_b, args[2]),
            OP_ASTORES => format!("store_operand_s(1, {} + 2 * {}, {})", op_a, op_b, args[2]),
            OP_ASTOREB => format!("store_operand_b(1, {} + {}, {})", op_a, op_b, args[2]),
